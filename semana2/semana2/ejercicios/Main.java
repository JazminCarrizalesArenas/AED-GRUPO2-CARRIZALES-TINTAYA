...
public class Main {
    public static void main(String[] args) {
        ...
        // crear cajoneria
        Cajoneria<Chocolatina> cajoneriaChoc = new Cajoneria<>(5);

        // crear cjas
        Caja<Chocolatina> caja1 = new Caja<>("Roja");
        Caja<Chocolatina> caja2 = new Caja<>("Azul");

     
        caja1.add(new Chocolatina("Nestlé"));
        caja1.add(new Chocolatina("Milka"));

        caja2.add(new Chocolatina("Nestlé"));
        caja2.add(new Chocolatina("Hershey"));
        cajoneriaChoc.add(caja1);
        cajoneriaChoc.add(caja2);

        // buscar
        System.out.println(cajoneriaChoc.search(new Chocolatina("Milka")));

        
        // eliminar
        System.out.println("Eliminado: " +
                cajoneriaChoc.eliminar(new Chocolatina("Nestlé")));

        //contar
        System.out.println("Repeticiones: " +
                cajoneriaChoc.contarOcurrencias(new Chocolatina("Nestlé")));

        //mostrar
        System.out.println(cajoneriaChoc);
    }
}
