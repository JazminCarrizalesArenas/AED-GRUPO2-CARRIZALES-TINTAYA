public class LinkedBST<E extends Comparable<E>>implements BinarySearchTree<E> {
    ...
    public void parenthesize() {
        System.out.println("REPRESENTACION PARENTHESIZE");
    ...
    private boolean isValidRec(Node<E> node,E min,E max) {
        ...
        return isValidRec(node.left,min,node.data)&&isValidRec(node.right,node.data,max);
    }
